...
GENERIC_IRC_COMMAND(TempChatBanIRCCommand)
...
GENERIC_GAME_COMMAND(TempChatBanGameCommand)
...
GENERIC_GAME_COMMAND(SpecModeGameCommand)
GENERIC_GAME_COMMAND(NormalModeGameCommand)
